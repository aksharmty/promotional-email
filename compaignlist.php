...
function deleteval(id)
{
		...
		if(m)
		{
				window.location.href='del_compaign.php?id='+id;
...
<body style="margin:0pt; padding:0pt" onload="DisplayTime()">
  ...
  <tr>
	...
	<table width="100%" height="186" border="1" align="center" cellpadding="9" cellspacing="0" bordercolor="#000000">
			  ...
			  <th height="21" colspan="16" align="center" bgcolor="#3B5998"><span class="style2"><font size="4">All Compaign List</font></span> </th>
              </tr>
              
              <tr align="center" class="title">
             <th width="8%" align="center" bgcolor="#9EB1DA"><span class="style3">S.No</span></th>
			  <th width="16%" align="center" bgcolor="#9EB1DA"><span class="style3">Email Date</span></th>
               
				<th width="52%" align="center" bgcolor="#9EB1DA"><span class="style3">TITLE </span></th>

                
                <th width="8%" align="center" bgcolor="#9EB1DA"><span class="style3">Update</span></th>
                <th width="8%" align="center" bgcolor="#9EB1DA"><span class="style3">Test Compaign</span></th>
			  ...
			  $rowsPerPage = 10;
				...
				$counter=($pageNum -1)*$rowsPerPage + 1;
							...
							$query1 = mysqli_query($connection,"SELECT * FROM email order by id desc LIMIT $offset, $rowsPerPage") or die("Query Fail #1");
              ...
              <tr class="data">
                 ...
                 <td width="16%" align="justify"><?php echo $data['date']; ?></td>
                  <td width="52%" align="justify"><?php echo $data['title']; ?></td>
               
                
                
                
                <td width="8%" align="center"><a href="editcompaign.php?id=<?php echo $data['id']; ?>" style="text-decoration:none;" >Modify & Resend</a></td>
                <td width="8%" align="center"><a href="testcompaign.php?id=<?php echo $data['id']; ?>" style="text-decoration:none;" >Send Test Email</a></td>
                <td width="8%" align="center"><a href="#" onclick="return deleteval(<?php echo $data['id']; ?>);" style="text-decoration:none;"  > Delete </a> </td>
              </tr>
  ...
  <?php
  $resultpaging  = mysqli_query($connection,"SELECT * FROM email order by id desc") or die('Error, query failed');
