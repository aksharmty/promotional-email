...
function deleteval(id)
{
		...
		if(m)
		{
				window.location.href='del_subcriber.php?id='+id;
...
<body style="margin:0pt; padding:0pt" onload="DisplayTime()">
  ...
  <tr>
	...
	<table width="100%" height="186" border="1" align="center" cellpadding="9" cellspacing="0" bordercolor="#000000">
			  ...
			  <th height="21" colspan="16" align="center" bgcolor="#3B5998"><span class="style2"><font size="4">All Subcriber List</font></span> </th>
              </tr>
              
              <tr align="center" class="title">
             <th width="8%" align="center" bgcolor="#9EB1DA"><span class="style3">S.No</span></th>
			  <th width="16%" align="center" bgcolor="#9EB1DA"><span class="style3">Email </span></th>
			  ...
			  $rowsPerPage = 20;
				...
				$counter=($pageNum -1)*$rowsPerPage + 1;
							...
							$query1 = mysqli_query($connection,"SELECT * FROM user order by id desc LIMIT $offset, $rowsPerPage") or die("Query Fail #1");
              ...
              <tr class="data">
                 ...
                 <td width="80%" align="justify"><?php echo $data['email']; ?></td>
                  
                <td width="10%" align="center"><a href="#" onclick="return deleteval(<?php echo $data['id']; ?>);" style="text-decoration:none;"  > Delete </a> </td>
              </tr>
  ...
  <?php
  $resultpaging  = mysqli_query($connection,"SELECT * FROM user order by id desc") or die('Error, query failed');
